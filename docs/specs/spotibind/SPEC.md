...
- `Player Mode`: One of Automatic, Spotify, Fastpotify, Sonora, Spotifly, or Off; the value is persisted in `UserDefaults`.
...
- Scope: transport controls, status, the six-mode target picker, Accessibility
